    ...
    <div class="container mt-36 mb-20">
        <div>
            ...
            <div class="px-4 pt-16 text-center items-center md:pt-24">
                <p class="font-bold text-white text-xl md:text-2xl mb-5">PEMINJAMAN</p>
            </div>
            <form class="mx-20">   
            ...
            <section id="search" class="mt-24 mb-32">
                <div class="container mx-12">
                  <div class="flex flex-wrap">
                    ...
                    <div class="flex">
                      ...
                      <div class="items-center justify-items-end mt-5 ml-52">
                          <a href="#" class="bg-green-400 hover:bg-green-500 text-white text-sm rounded-full px-2 py-1 shadow-lg">Laporan KKI</a>
                      </div>
                  </div>
                  <div class="flex">
                      <h2 class="text-slate-400 text-dark font-normal text-3xl mb-5 mr-4 max-w-md lg:text-sm">
              ...
              <div class="flex">
                ...
                <div class="items-center justify-items-end mt-5 ml-52">
                    <a href="#" class="bg-blue-400 hover:bg-blue-500 text-white text-sm rounded-full px-2 py-1 shadow-lg">Laporan PKM</a>
                </div>
            </div>
            <div class="flex">
                <h2 class="text-slate-400 text-dark font-normal text-3xl mb-5 mr-4 max-w-md lg:text-sm">
