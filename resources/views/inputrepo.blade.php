                        ...
                        <form>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="judul"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="isi dengan judul..." required>
                            </div>
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <select id="koleksi"
                                        ...
                                        <option value="koleksia">Koleksi A</option>
                                        <option value="koleksib">Koleksi B</option>
                                        <option value="koleksic">Koleksi C</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="namapembimbing"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Isi dengan nama lengkap pembimbing..." required>
                                </div>
                            </div>
                            <div class="mb-6">
                                <label for="subject"
                                ...
                                <input type="text" id="subject"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Isi dengan subject..." required>
                            </div>
                            <div class="mb-6">
                                <label for="keyword"
                                ...
                                <input type="text" id="keyword"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Isi dengan kata kunci..." required>
                            </div>
                            <div class="mb-6">
                                <form>
                                    <div
                                        ...
                                        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                            ...
                                            <textarea id="editor" rows="8"
                                                ...
                                                placeholder="Isi Abstrak di sini..." required></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
