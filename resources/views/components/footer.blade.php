...
{{-- <div class="mx-auto w-full-screen">
    <section class=" bg-violet-700 w-full pt-24 pb-12">
        <div class="container">
          <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
              <h2 class="font-bold text-4xl text-white mb-5">WPU</h2>
              <h3 class="font-bold text-2xl mb-2">Hubungi Kami</h3>
              <p>sopyansauri09@gmail.com</p>
              <p>Kp. Sukamulya Ds. Sukanagalih Kec. Rajapolah</p>
              <p>Tasikmalaya</p>
            </div>
            ...
            <div class="w-full px-4 mb-12 md:w-1/3">
              ...
              <ul class="text-slate-300">
                ...
                <li>
                  <a href="#client" class="inline-block text-base hover:text-primary mb-3">Clinet</a>
                </li>
                <li>
          ...
          <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex items-center justify-center mb-5">
              <!-- Youtube Simple Icon -->
              <a
                href="https://www.youtube.com/@sopyansauri9034"
                target="_blank"
              ...
              <!-- Instagram Simple Icon -->
              <a
                href="https://www.instagram.com/saursopyan"
                target="_blank"
                class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg
              ...
              <!-- Twitter Simple Icon -->
              <a
                href="https://www.twitter.com/sopyansauri09"
                target="_blank"
                class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg
              ...
              <!-- Facebook Simple Icon -->
              <a
                href="https://www.facebook.com/sopyand.skmc"
                target="_blank"
                class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg
              ...
              <!-- Tiktok Simple Icon -->
              <a
                href="https://www.tiktok.com/@dsdsshop"
                target="_blank"
                class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg
              ...
              <a
                href="https://wa.me/6287797767831"
                target="_blank"
                class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg
            ...
            <p class="font-medium text-xs text-slate-500 text-center">Dibuat Oleh <span class="text-pink-500">❤</span> <a href="https://www.instagram.com/saursopyan" target="_blank" class="font-bold text-primary"> Sopyan Sauri</a>, menggunakan <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500"> Tailwind CSS.</a> </p>
          </div>
        </div>
    </section>
</div> --}}
