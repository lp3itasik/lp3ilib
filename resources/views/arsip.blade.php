        ...
        <div>
            ...
            <div class="container mx-auto px-10 md:flex flex-wrap gap-6 justify-evenly text-right">
                <div class="group relative">
                    <div class="group-hover:opacity-100 opacity-0 transition-all ease-in-out duration-500 absolute justify-center w-full -bottom-5 md:bottom-4 flex">
                        <a href="#" class="hover:bg-[#ECAE30] transition-all ease-in-out duration-500 font-semibold shadow-2xl shadow-primary px-7 py-3 rounded-full bg-primary text-white">
                            <i class="fa-solid fa-download"></i>
                        </a>
                    </div>
                    <div class="rounded-3xl shadow-lg bg-white  group-hover:border-2 transition-all ease-in-out duration-500 border-[#ECAE30] overflow-hidden mb-10 lg:w-[600px]">
