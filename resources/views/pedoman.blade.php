            ...
            <th scope="row" class="px-6 py-4 text-blue-400 font-bold text-lg whitespace-nowrap dark:text-white">
                <div class="group relative">
                    <div
                        ...
                        <a href="https://opac.politekniklp3i-tasikmalaya.ac.id:8444/download-pedoman?file_name={{ $r->file_name }}"
                    ...
                    <div
                        ...
                        <div class="flex px-4 py-4 items-center">
                            <a href="https://opac.politekniklp3i-tasikmalaya.ac.id:8444/download-pedoman?file_name={{ $r->file_name }}" class="text-slate-600">
