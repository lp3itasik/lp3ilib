...
<body class="mx-auto max-w-screen bg-center bg-no-repeat bg-[url('/img/pattern.svg')] bg-cover">
    ...
    <div class="container mx-auto justify-center md:ml-auto mb-20">
            <div class="px-4 pt-16 text-center items-center md:pt-10">
                ...
                <p class="mb-1 text-black text-lg font-bold text-center">Perpustakaan Politeknik LP3I Kampus Tasikmalaya memiliki:</p>
            ...
            <div class="container mx-auto px-10 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div class="">
                            <lottie-player src="{{asset('animation/1.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-8"></lottie-player>
                        </div>
                    </div>
                    <div class="w-2/3 p-2">
                ...
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div>
                            <lottie-player src="{{asset('animation/2.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-[75px]"></lottie-player>
                ...
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div>
                            <lottie-player src="{{asset('animation/3.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-8"></lottie-player>
                            <hr class="border border-gray-300">
                        </div>
                    </div>
                    <div class="w-2/3 p-2">
                ...
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div>
                            <lottie-player src="{{asset('animation/4.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-16"></lottie-player>
                            <hr class="border border-gray-300">
                        </div>
                    </div>
                    <div class="w-2/3 p-2">
                ...
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div>
                            <lottie-player src="{{asset('animation/5.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-14"></lottie-player>
                            <hr class="border border-gray-300">
                        </div>
                    </div>
                    <div class="w-2/3 p-2">
                ...
                <div class="flex items-end">
                    <div class="w-1/3 p-2 hidden md:block rounded-xl">
                        <div>
                            <lottie-player src="{{asset('animation/6.json')}}" background="transparent"  speed="1"  style="width: 250px; height: 300px;" loop autoplay class="-ml-3 -mb-8"></lottie-player>
                            <hr class="border border-gray-300">
                        </div>
                    </div>
                    <div class="w-2/3 p-2">
            ...
            <div class="container mx-auto">
                <div class="ml-16 md:flex md:flex-wrap md:gap-6 md:justify-evenly">
                    <div>
                        <input type="text" id="judul_buku" class="md:-ml-12 mt-4 bg-gray-50 border shadow-lg border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-80 h-12 md:w-[550px] p-2.5" placeholder="Tulis judul buku disini..." required>
                    </div>
                    <div>
                        <input type="text" id="pengarang" class="md:-ml-8 mt-4 bg-gray-50 border shadow-lg border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-80 h-12 md:w-[650px] p-2.5" placeholder="Tulis Nama Pengarang disini..." required>
                    </div>
                    <button type="button" class="ml-20 md:-ml-8 mt-4 text-white shadow-lg bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-sm px-9 py-2.5 text-center inline-flex items-center">
                        Ajukan
