        ...
        <div class="container mx-auto my-8">
            <div>
                <div class="px-4 text-center items-center">
                    <p class="font-bold text-black text-xl md:text-2xl mb-7">Input Arsip</p>
                </div>
                <section id="inputrepo" class="px-4">
                    <div class="container md:flex md:flex-row gap-6 mx-auto">
                        <div class="w-full md:w-1/2 mx-auto p-6 mb-10 shadow-lg bg-white rounded-2xl border">
                        ...
                        <div class="w-full md:w-1/2 overflow-x-auto bg-white p-6 border shadow-lg rounded-2xl">
                ...
                const uploadBerkas = async (event) => {
                    ...
                    if (file.files.length > 0) {
                        ...
                        if (konfirmasi) {
                            ...
                            const responseDatabase = await axios.post(`/inputarsip`, data, {
                                headers: {
                                ...
                                if (responseDatabase.data.id) {
                                    reader.onload = async (event) => {
                                        ...
                                        const responseUpload = await axios.post(
                                            `https://opac.politekniklp3i-tasikmalaya.ac.id:8444/upload-arsip`,
                                            repository);
